...
% sink velocity
% for sv, we have u = grad(phi) where phi = -1/(2*pi)*logr 
% the green's function for laplacian and for the pressure 
% we have p = delta - k^2/(2*pi)*logr   
